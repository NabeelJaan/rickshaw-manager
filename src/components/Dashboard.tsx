  ...
  return (
    <div className="max-w-7xl mx-auto px-3 md:px-10 py-4 md:py-16 space-y-5 md:space-y-20">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        {filteredStatCards.map((card, i) => (
          <div key={i} className="bg-white p-3 md:p-6 rounded-xl md:rounded-2xl border border-zinc-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex flex-col gap-1.5 md:gap-3">
            ...
            <div>
              <p className="text-[10px] md:text-[13px] text-zinc-500 font-medium">{card.title}</p>
              <h3 className={`text-[16px] md:text-[26px] font-semibold tracking-tight font-number mt-0.5 md:mt-1 ${card.color}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
          <div className="bg-white p-3 md:p-6 rounded-xl md:rounded-2xl border border-zinc-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
            <div className="flex items-center justify-between mb-2 md:mb-4">
              <div className="flex items-center gap-1.5 md:gap-2">
                <div className="w-6 h-6 md:w-8 md:h-8 rounded-md md:rounded-lg bg-amber-50 flex items-center justify-center">
                  <Users className="w-3 h-3 md:w-4 md:h-4 text-amber-600" />
                </div>
                <h3 className="text-[12px] md:text-[15px] font-semibold text-zinc-900">Monthly Leave</h3>
              </div>
            ...
            {leaveRecords.length === 0 ? (
              ...
              <div className="space-y-1.5 md:space-y-2">
                {leaveRecords.map(t => (
                  <div key={t.id} className="flex items-center gap-2 p-2 md:p-3 bg-zinc-50 rounded-lg md:rounded-xl">
          ...
          <div className="bg-white p-3 md:p-6 rounded-xl md:rounded-2xl border border-zinc-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
            <div className="flex items-center gap-1.5 md:gap-2 mb-2 md:mb-4">
              <div className="w-6 h-6 md:w-8 md:h-8 rounded-md md:rounded-lg bg-blue-50 flex items-center justify-center">
                <Car className="w-3 h-3 md:w-4 md:h-4 text-blue-600" />
              </div>
              <h3 className="text-[12px] md:text-[15px] font-semibold text-zinc-900">Last Oil Change</h3>
            </div>
            {oilChangeRecords.length === 0 ? (
              ...
              <div className="space-y-2 md:space-y-3">
                {oilChangeRecords.map(t => (
                  <div key={t.id} className="flex justify-between items-start p-2 md:p-3 bg-zinc-50 rounded-lg md:rounded-xl">
                    <div>
                      {t.rickshaw_number && (
      ...
      <div className="bg-white rounded-xl md:rounded-2xl border border-zinc-200/60 shadow-[0_2px_8px_rgba(0,0,0,0.04)] overflow-hidden">
        <div className="p-3 md:p-6 border-b border-zinc-100">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-1.5 md:gap-2">
              <div className="flex items-center gap-1 px-2 py-1 md:px-3 md:py-1.5 bg-emerald-50 rounded-md md:rounded-lg">
              ...
              <div className="flex items-center gap-1 px-2 py-1 md:px-3 md:py-1.5 bg-rose-50 rounded-md md:rounded-lg">
              ...
              <div className="flex items-center gap-1 px-2 py-1 md:px-3 md:py-1.5 bg-amber-50 rounded-md md:rounded-lg">
          ...
          <div className="flex justify-between items-center mb-3 md:mb-6">
            ...
            <div className="flex bg-zinc-100 p-0.5 md:p-1 rounded-lg md:rounded-xl">
              <button 
                ...
                className={`px-2 py-1 md:px-3 md:py-1.5 text-[10px] md:text-[13px] rounded-md md:rounded-lg transition-all ${chartView === 'daily' ? 'bg-white shadow-sm text-zinc-900 font-medium' : 'text-zinc-500 hover:text-zinc-700'}`}
              >
                Daily
              </button>
              <button 
                onClick={() => setChartView('monthly')}
                className={`px-2 py-1 md:px-3 md:py-1.5 text-[10px] md:text-[13px] rounded-md md:rounded-lg transition-all ${chartView === 'monthly' ? 'bg-white shadow-sm text-zinc-900 font-medium' : 'text-zinc-500 hover:text-zinc-700'}`}
              >
                Monthly
              </button>
            </div>
